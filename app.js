...
(() => {
    ...
    <div class="modal" role="dialog" aria-modal="true" aria-label="${l.area} listing">
      <div class="modal-top">
        ...
        <div class="modal-actions">
          <button class="modal-share cmp-action ${state.compare.has(l.id) ? "on" : ""}" data-cmp="${l.id}">${state.compare.has(l.id) ? "✓ Comparing" : "⇄ Compare"}</button>
  ...
  modalRoot.addEventListener("click", (e) => {
    ...
    const cmpA = e.target.closest("[data-cmp]"); if (cmpA) return toggleCompare(+cmpA.dataset.cmp);
